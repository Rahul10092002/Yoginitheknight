...
function Services() {
  return (
    <div className="flex flex-col text-center justify-center pt-12 ">
      <h1 className=" text-xl font-semibold text-slate-950 ">OUR SERVICES</h1>
      <h2 className=" align-middle flex justify-center  mt-2 text-2xl font-bold sm:text-4xl tracking-wide sm:text-left bg-gradient-to-tr from-indigo-500 to-violet-500 bg-clip-text text-transparent">
